...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_ADV_INTERVAL_MS, 2000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_ADV_DURATION_MS, 10000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_SLEEP_DURATION_MS, 15000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_TX_POWER_DBM, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_UBX_EVKNORAB2, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_UBX_EVKNORAB2_NRF54L15_CPUAPP, 1);
